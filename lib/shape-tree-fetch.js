    ...
    try {
      ...
      case 'POST': {
        ...
        if (isPlantRequest) {
          ...
          const payloadGraph = await RdfSerialization.parseRdf(payload, requestUrl, mediaType);
          ...
          const [finalLocation, respBody, respMediaType]
                = await Ecosystem.plantShapeTreeInstance(shapeTreeUrl, postedContainer, toAdd, payloadGraph);

          resp.headers.set('Location', finalLocation.href);
